...
// #define __NEED_pthread_mutex_t // XXXih
// #define __NEED_pthread_cond_t // XXXih
...
#define PTHREAD_COND_INITIALIZER { __GMUSL_pcnd_init() }
...
#if defined(__USE_XOPEN2K) || 1 // XXXih
